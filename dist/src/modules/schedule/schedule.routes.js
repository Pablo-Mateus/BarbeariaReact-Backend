...
router.post('/', authorize('owner'), validate({ body: defineScheduleSchema }), scheduleController.define);
// Get times for a day
router.post('/times', validate({ body: getTimesSchema }), scheduleController.getTimes);
